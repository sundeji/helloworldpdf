...
(function($){ 	
	...
	*/
	...
	var onGripDrag = function(e){	
		...
		var mw_f = t.opt.minWidth2, i = drag.i ;	//cell's min width
		var mw_s = t.opt.minWidth1;
		var l = t.cs*1.5 + mw_f + t.b;
        var last = i == t.ln-1;                 			//check if it is the last column's grip (usually hidden)
        var min = i? t.g[i-1].position().left+t.cs+mw_f: l;	//min position according to the contiguous cells
		var max =  
				t.g[i+1].position().left-t.cs-mw_s; 								//max position according to the contiguous cells 
